...
RDEPEND="
	...
	~mate-base/mate-session-manager-9999
	...
	themes? (
		~x11-themes/mate-backgrounds-9999
		~x11-themes/mate-icon-theme-9999
		~x11-themes/mate-icon-theme-faenza-9999
		~x11-themes/mate-themes-9999
	)
	extras? (
		~app-arch/engrampa-9999
		~app-editors/pluma-9999
		~app-text/atril-9999
		~mate-extra/mate-power-manager-9999
		~mate-extra/mate-screensaver-9999
		~mate-extra/mate-system-monitor-9999
		~mate-extra/mate-utils-9999
		~media-gfx/eom-9999
	)
"
